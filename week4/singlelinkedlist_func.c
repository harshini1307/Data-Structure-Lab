...
int main()
{
	...
	printf("___________________FUNCTIONS__________________\n");
	printf("1. Create sll\n");
	...
	printf("14. Reverse printing the list using recursion \n");
	printf("15. Reverse printing the list using array \n");
	printf("16. Sort single linked list using Bubble sort \n");
	printf("17. Sort single linked list using Bubble sort \n");
	printf("18. Exit \n");
	printf("**********END****************\n");
